    ...
    <>
      <div className="bg-main shadow-md sticky top-0 z-20">
        <div className="container mx-auto py-6 px-2 lg:grid gap-10 grid-cols-7 justify-between items-center">
          ...
          {/* menu */}
          <div className="col-span-3 font-medium text-sm hidden xl:gap-14 2xl:gap-20 justify-between lg:flex xl:justify-end items-centers">
            ...
            <NavLink to="/favorite" className={`${Hover} relative`}>
              ...
              <div className="w-5 h-5 flex-colo rounde-full text-xs bg-subMain text-white absolute -top-5 -right-1">
                {likedMovies?.length}
              </div>
            </NavLink>
          </div>
